...
class Addons_model {
    ...
    public function search_available_modules(){
        ...
        $new_module = $this->session->get('add_new_module');
        if(isset($new_module) && !empty($new_module)){
            ...
            $this->session->set('add_new_module', $result);
            return $result;
        }
    }
    ...
    public function search_available_themes(){
        $new_themes = $this->session->set('add_new_theme');
        if(isset($new_themes) && !empty($new_themes)){
            ...
            $this->session->set('add_new_theme', $result);
            return $result;
        }
    }
