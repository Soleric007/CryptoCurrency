<div class="cryp_wrapper">
    <div class="form-content login mt-4 mb-4">
        ...
        <h3 class="user-login-title"><?php echo display('account_login') ?></h3>
            ...
            <div class="form-group">
                <label for=""><i class="fas fa-gift"></i>Redeem Code</label>
                <input type="text" class="form-control" id="" placeholder="Redeem Code">
                <small id="e_nameHelp" class="form-text text-muted">Input Redeem code to claim Bonuses</small>
            </div>
            <?php if ($security) { ?>                        
                <div class="form-group">
                    <?php echo $widget;?>
