                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slide-text text-center">
                                    ...
                                    <p>With a multi-billion dollar market capitalization, crypto is here to stay. It's not going anywhere.</p>
                                    <div class="slide-buttons">
                                        <a href="<?php echo base_url('register') ?>" class="slide-btn btn-kingfisher-daisy">Start Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slide-text">
                                    <h2><?php echo htmlspecialchars_decode($slide_h1); ?></h2>
                                    <p>We're working on making sure that our incentives are in place and that our legislation promotes crypto and blockchain and is forward-thinking. We want to make sure that we're creating as much of an equity framework from an educational perspective as we possibly can.</p>
                                    <div class="slide-buttons">
